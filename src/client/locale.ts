...
export const zh: Record<string, string> = {
  ...
  'detail.tools': '工具',
  'preset.nav': 'Preset 上下文',
  'preset.title': 'Preset 上下文',
  'preset.intro': '设置每个 Agent preset 的默认上下文。仅对之后新建或恢复的会话生效；输入框里的「会话上下文」仍然只改当前会话。',
  'preset.readonly': '当前设置存储不可写；你可以查看工具，但无法保存微调。',
  'preset.choose': 'Agent preset',
  'preset.tools': '系统工具（{count}）',
...
export const en: Record<string, string> = {
  ...
  'detail.tools': 'tools',
  'preset.nav': 'Preset context',
  'preset.title': 'Preset context',
  'preset.intro': 'Choose the default context for each agent preset. This applies only to sessions created or resumed afterward; the composer\'s Session context still changes only the current session.',
  'preset.readonly': 'Settings storage is read-only. You can inspect tools, but changes cannot be saved.',
  'preset.choose': 'Agent preset',
  'preset.tools': 'System tools ({count})',
