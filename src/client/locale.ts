...
export const zh: Record<string, string> = {
  ...
  'preset.intro': '设置每个 Agent preset 的默认工具集合，之后新建或恢复的会话会继承它。输入框里的「会话上下文」仍然只改当前会话。',
...
export const en: Record<string, string> = {
  ...
  'preset.nav': 'Agent Toolkit',
  'preset.title': 'Agent Toolkit',
  'preset.intro': 'Choose the default tool set each agent preset starts from; sessions created or resumed afterward inherit it. The composer\'s Session context still changes only the current session.',
