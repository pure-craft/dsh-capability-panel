...
export const PANEL_CSS = [
  ...
  '.ci-preset-filter{flex:1 1 200px;min-width:160px}',
  '.ci-preset-group{padding:0}',
  '.ci-preset-group .ci-preset-tool-list{margin:0;padding-left:14px}',
  '.ci-preset-picker-label{display:grid;gap:6px;margin-bottom:18px;color:var(--dsw-alias-label-primary,#0f1115);font-weight:600}',
